        ...
        try {
            ...
            while (rsSqlReceitas.next()) {
                ...
                if (receitaDisponivel == true) {
                    String receitasDisponiveis = "[" + numReceita + "] - " + nomeReceita + " - disponível.";

                    InterfaceController.receitasDisponiveis = receitasDisponiveis;
                } else {
                    String receitasIndisponiveis = "[" + numReceita + "] - " + nomeReceita + " - indisponível.";
                    InterfaceController.receitasIndisponiveis = receitasIndisponiveis;
                }
                numReceita++;
